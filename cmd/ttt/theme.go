...
func buildStyleMap(theme config.ThemeConfig) term.StyleMap {
	...
	applyStyleDef(&m, term.StyleSidebarHeader, theme.Sidebar.Header)
	applyStyleDef(&m, term.StyleSidebarItem, theme.Sidebar.Item)
	applyStyleDef(&m, term.StyleSidebarSelected, theme.Sidebar.Selected)
	applyStyleDef(&m, term.StylePaletteBorder, theme.Border)
	applyStyleDef(&m, term.StylePaletteInput, theme.Dialog.Input)
