...
// renameVia drives the explorer's inline rename editor for the node at path,
// replacing its name with newName.
func (h *testHarness) renameVia(path, newName string) {
	...
	// The editor is pre-filled with the current basename and places no
