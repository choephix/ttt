...
// The inline rename editor is pre-filled with the current basename and places
// no selection, so the old name has to be cleared before typing the new one.
// Submitting leaves focus in the explorer tree, where the rename started.
